...
public class ProcessPdfDocument {
    ...
    public void doOCR(String inputPdf, String outputPdf, Boolean returnOriginalImages) throws TesseractException {

        if(returnOriginalImages)
        {
            this.makePdfWithOriginalImages(inputPdf, outputPdf);
        }
        else {
