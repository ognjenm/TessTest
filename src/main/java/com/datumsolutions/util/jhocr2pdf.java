...
public class Jhocr2pdf implements ContentHandler, ErrorHandler {
    ...
    public void startElement(String uri, String localName, String qName,
        ...
        if(localName.equals("div")) {
            ...
            if(null != klass && klass.equals("ocr_page")) {
                ...
                float imgWidth = Float.valueOf(title[title.length - 3].replace(";", "")) - Float.valueOf(title[title.length - 5].replace(";", ""));
                float imgHeight = Float.valueOf(title[title.length - 1].replace(";", "")) - Float.valueOf(title[title.length - 4].replace(";", ""));
                imgWidth = 2000;
                imgHeight = 3000;
    ...
    public void parse(BufferedReader fileName, int pageNum) throws SAXException, IOException {
        siglePageOCRNum = pageNum;
        XMLReader reader;
        reader = XMLReaderFactory.createXMLReader();
        reader.setContentHandler(this);
        ...
        final BufferedReader characterStream = fileName;
        // skip past the DOCTYPE line
        characterStream.readLine();
